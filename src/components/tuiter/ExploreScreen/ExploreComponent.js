        ...
        <>
            ...
            <nav className="mb-3">
                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a className="nav-item nav-link d-none d-lg-block" id="nav-entertainment-tab" data-toggle="tab" href="../entertainment.html" role="tab" aria-controls="nav-entertainment" aria-selected="true">Entertainment</a>
                </div>
            </nav>
